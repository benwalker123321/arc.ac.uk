...
<html lang="en">
  <head>
    ...
    <title>ARC Lecturer Timetable</title>
  ...
  <body>
	...
	?> 
         ...
         ?>
          ...
          <li class="active"><a href="../../../../../xampp/arc.ac.uk/index.php/lecturerTimetable"> Timetable</a></li> 
        <?php
         }
        }  
 ?>
    ...
    <div class="container">
      ...
      <center>
       ...
       <tr>
                    ...
                    $lecturer->loadLecturerTimetable($staffID); ?>
       </tr>     
       </table>
     </center>
      </div>
