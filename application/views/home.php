...
defined('BASEPATH') OR exit('No direct script access allowed');
        ...
        include_once 'backend/arcSystem/functions/login&register/userLogin.php';
        include_once 'backend/arcSystem/functions/admin/authoriseHome.php';
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="../../../../../xampp/arc.ac.uk/index.php/">Home</a></li>
      ...
      <div id="content">
        <h1>Anglia Ruskin College Attendance Application Home</h1>
        
                        <h2>Sign In Form</h2>
                                
         <h3> Enter username and password below </h3>
          
      	<center>
            <?php
                include '/../helpers/security.php'; // prevents XSS Attacks 
            ...
            <form method="post" id="loginForm" name="loginForm"> 
                ...
                <input type="text" id="username" name="username" autocomplete="off" 
                    <?php echo isset($fields['username']) ? ' value="' . escape($fields['username']).'"': ''?> > <br>
					    Password <br>
		<input type="password" id="password" name="password" autocomplete="off" 
                    <?php echo isset($fields['password']) ? ' value="' . escape($fields['password']).'"': ''?>> <br>
                <br>           
		<input type="submit" name="loginBtn" id="loginBtn" value="Sign In">
