        ...
        if(isset($_POST['createSession'])){
           ...
           //       $studentID = 62;
                ...
                // find the students that belong to the groupID selected in the form. 
                    ...
                    $studentIDb = substr($studentID, 3, -2); // views second id
                    $studentIDc = substr($studentID, 6, -1); // views second id
                    ...
                    echo $studentIDc;
                     ...
                     $createAttendanceCard3 = "INSERT INTO attendance VALUES('" . $attendanceCardID . "', '". $sessionIDB ."', '".$studentIDc."','".$attended."')";
                     $result3 = $db->query($createAttendanceCard3);
